...
\end{verbatim}
\item[2)] \textbf{Facts} \vspace{10pt} \\
...
\end{verbatim}}
\item[3)] \textbf{Scenarios} \vspace{10pt} \\
Scenarios are predicates that demonstrate various possible states of the model. They are designed to illustrate realistic situations that could occur in practice. \vspace{10pt} \\
Scenario 1: \\
\small{
\begin{verbatim}
...
We can notice how a company can have an internship already archived as a past project. In addition, we can see how a student that applied can also have filled the form required for the first screening stage of the selection process. \vspace{10pt} \\
Scenario 2:
\begin{verbatim}
...
\end{center}
An important thing to notice is how only one of the candidates actually gets to participate in the internship while the other doesn't get through the final seletion. \vspace{10pt} \\
Scenario 3:
\begin{verbatim}
